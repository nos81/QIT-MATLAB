...
disp('Now Bob announces on a public classical channel that he has received the qubits.')
...
disp('If an unmatching bit is found, the reason is either an eavesdropper or a noisy channel.')
