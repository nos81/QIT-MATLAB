...
% SCROFULOUS  Sequence for correcting pulse length errors.
%  s = scrofulous(theta [, phi])
%
%  Returns the SCROFULOUS control sequence s for correcting errors
...
ph1 = acos(-pi*cos(th1)/(2*th1*sin(theta/2))) +phi;
